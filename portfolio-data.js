...
const PORTFOLIO = [
  ...
  },
  {
    ...
    projectType: "Website Concept",
    isClientWork: false,
    industry: "Hospitality / Diving & Adventure Tourism",
    category: "tourism",
  ...
  },
  {
    ...
    badge: "Hospitality Concept",
    description:
      "A property website designed around the setting itself — letting the location and the atmosphere do the persuading rather than leaning on heavy copy.",
    focusAreas: [
      "Villa accommodations shown in a dedicated gallery",
      "Setting-led visual presentation",
      "Minimal, atmosphere-first layout",
      "Clear property information structure",
    ],
    desktopImage: "/images/the-view-desktop.webp",
    mobileImage: "/images/the-view-mobile.webp",
    liveUrl: "https://lendezstudio.github.io/the-view/",
    ctaLabel: "View Website Concept",
    featured: false,
    displayOrder: 6,
    layout: "media-left",
